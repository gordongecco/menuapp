...
const menu1 = [
  ...
  { name: 'menu 4', parent: 'menu 10', color: 'yellow' },
  ...
  { name: 'menu 10', parent: 'menu 12', color: 'yellow' },
  { name: 'menu 11', parent: '', color: 'blue' },
  { name: 'menu 12', parent: 'menu 6', color: 'purple' },
  ...
  { name: 'menu 19', parent: '', color: 'purple' },
];
const menu2 = [
